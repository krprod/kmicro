...
//    private String BOOTSTRAP_SERVERS_CONFIG;
    ...
    public ConsumerFactory<String, String> paymentConsumerFactory() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "dev" + "_" + "payment-group");
...
//        properties.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, Integer.parseInt(this.environment.getProperty("kafka.consumers.sessionTimeoutMsConfigExcelUpload")));
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> payementKafkaListenerContainerFactory() {
