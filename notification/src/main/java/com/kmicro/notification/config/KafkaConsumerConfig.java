...
//    private String BOOTSTRAP_SERVERS_CONFIG;
    ...
    public ConsumerFactory<String, String> notificationConsumerFactory() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "dev" + "_" + "notification-group");
...
//        properties.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, Integer.parseInt(this.environment.getProperty("kafka.consumers.sessionTimeoutMsConfigExcelUpload")));
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> notificationKafkaListenerContainerFactory() {
        ...
        concurrentKafkaListenerContainerFactory.setConsumerFactory(notificationConsumerFactory());
