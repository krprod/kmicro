...
@Slf4j
@Service
public class MockEmaiData {

    private  Context createCntx(Order order){
...
//        order.setShippingAddress(shippingAddress);
    ...
    public Context getContext(){
        return this.createCntx(this.getOrderDetails());
    }

    public FileSystemResource getMockFile(String attachmentPath){
        return new FileSystemResource(new File(attachmentPath));
    }

    public Map<String, String> getVerificationEmailContent(){
        Map<String, String> verificationMap = new HashMap<>();
        verificationMap.put("title","Identity Verification Mail");
        verificationMap.put("heroImageUrl","https://id-mail-assets.atlassian.com/template/aid_signup_welcome_verify_cobranded_adg/jira-people.png");
        verificationMap.put("greetingByName","Hi Krishna, Here is your OTP");
//        verificationMap.put("msgLine1","");
        verificationMap.put("msgLine2","To access Our Platform, enter the following code:");
        verificationMap.put("otpCode","52335684");
